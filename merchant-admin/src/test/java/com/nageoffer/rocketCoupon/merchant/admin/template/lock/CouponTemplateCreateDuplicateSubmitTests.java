...
package com.nageoffer.rocketCoupon.merchant.admin.template.lock;

import com.alibaba.fastjson2.JSON;
import com.nageoffer.rocketCoupon.merchant.admin.controller.CouponTemplateController;
            ...
            executorService.execute(() -> {
                ...
                try {
                    couponTemplateController
                            .createCouponTemplate(JSON.parseObject(paramJSONStr, CouponTemplateSaveReqDTO.class));
                } catch (Exception ex) {
